...
The Netherlands is a Schengen area country. Canadian citizens do not need a visa to travel to countries within the Schengen area. However, visa-free travel only applies to stays of up to 90 days in any 180-day period. Stays are cumulative and include visits to any Schengen area country.

Member states may temporarily reintroduce controls at internal border crossings within the Schengen area. You may be required to pass through immigration controls when entering the Netherlands, even if arriving from another Schengen area country. Verify if border controls are in effect before you travel to the Netherlands.
...
[Guide to temporary entry into the Netherlands under CETA](https://www.international.gc.ca/trade-commerce/trade-agreements-accords-commerciaux/agr-acc/ceta-aecg/temporary-entry-admission-temporaire-guide/netherlands-PaysBas.aspx?lang=eng)
