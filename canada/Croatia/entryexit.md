...
Member states may reintroduce temporary controls at internal border crossings within the Schengen area. You may be required to pass through immigration controls when entering Croatia, even if arriving from another Schengen area country. Verify if temporary border controls are in effect before you travel to Croatia.
