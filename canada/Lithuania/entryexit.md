...
Lithuania is a Schengen area country. Canadian citizens do not need a visa to travel to countries within the Schengen area. However, visa-free travel only applies to stays of up to 90 days in any 180-day period. Stays are cumulative and include visits to any Schengen area country.

Member states may temporarily reintroduce controls at internal border crossings within the Schengen area. You may be required to pass through immigration controls when entering Lithuania, even if arriving from another Schengen area country. Verify if border controls are in effect before you travel to Lithuania.
...
Lithuania enforces an EU entry ban on vehicles with Russian or Belarusian license plates.

Certain exceptions apply. You should verify with the Lithuanian authorities before you attempt to cross the border in a private vehicle from Belarus or Russia.

#### Useful links

* [Updated procedure for admitting cars with Belarusian registration](https://lrmuitine.lt/web/guest/naujienos/aktualijos/aktualija?p_p_id=EXT_WPLISTALLNEWS&p_p_lifecycle=0&_EXT_WPLISTALLNEWS_obj_id=090004d2801f1006#en) – Customs of the Republic of Lithuania
* [Sanction requirements for vehicles registered in Russia](https://lrmuitine.lt/web/guest/naujienos/aktualijos/aktualija?p_p_id=EXT_WPLISTALLNEWS&p_p_lifecycle=0&_EXT_WPLISTALLNEWS_obj_id=090004d2801c0364#en) – Customs of the Republic of Lithuania

### Curonian Spit

The Curonian Spit, an elongated sand dune that separates the Curonian Lagoon from the Baltic Sea, is divided between Lithuania and Russia. The border-crossing point at Nida between Russia (Kaliningrad) and Lithuania is closed.

### Health Insurance

You may be requested to show proof of medical insurance upon entry in Lithuania. If you do not have proof of insurance coverage, you may be required to obtain health insurance from a Lithuanian insurance company when you arrive.
